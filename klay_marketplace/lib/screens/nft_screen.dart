...
import 'package:klaymarket/animations/fade_animation.dart';
import 'package:klaymarket/widgets/blur_container.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Stack(
            children: [
              // Hero 위젯은 앱의 페이지 또는 루트 사이의 이동에서 animation을 만들어준다
              Hero(
                // 이미지의 값을 Hero의 태그로 사용하여 구분
                tag: image,
